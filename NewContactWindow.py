...
class NewContactWindow(QMainWindow):
    def __init__(self):
        ...
        self.label_new_contact.setStyleSheet("background-color: rgb(83, 83, 83);\n"
...
"color: rgb(186, 186, 186);")
        ...
        self.dob_label.setStyleSheet("background-color: rgb(83, 83, 83);\n"
"color: rgb(186, 186, 186);")
    ...
    def retranslateUi(self, NewContactWindow):
        ...
        self.setWindowTitle(_translate("NewContactWindow", "MainWindow"))
