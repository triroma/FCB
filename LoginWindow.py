...
class LoginWindow(QMainWindow):
    def __init__(self):
        ...
        self.label_login.setGeometry(QtCore.QRect(115, 50, 320, 50))
        font = QtGui.QFont()
...
"color: rgb(186, 186, 186);")
        ...
        self.registration_btn.setGeometry(QtCore.QRect(70, 320, 150, 50))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
...
"color: rgb(186, 186, 186);")
        ...
        self.cancel_btn.setGeometry(QtCore.QRect(70, 380, 150, 50))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
...
"color: rgb(186, 186, 186);")
        ...
        self.label_forgot_pass.setGeometry(QtCore.QRect(245, 340, 150, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_forgot_pass.setFont(font)
        self.label_forgot_pass.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.checkBox_remember_me.setGeometry(QtCore.QRect(260, 260, 150, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.checkBox_truesight_pass.setGeometry(QtCore.QRect(260, 300, 150, 20))
