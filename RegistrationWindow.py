...
class RegistrationWindow(QMainWindow):
    def __init__(self):
        ...
        self.label_registration.setStyleSheet("background-color: rgb(150, 150, 150);\n"
                                              "color: rgb(50, 50, 50);")
        ...
        self.label_dob.setStyleSheet("background-color: rgb(150, 150, 150);\n"
                                     "color: rgb(50, 50, 50);")
    ...
    def retranslateUi(self, RegistrationWindow):
        ...
        self.setWindowTitle(_translate("RegistrationWindow", "Регистрация"))
